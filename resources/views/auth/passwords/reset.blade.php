...
<main class="auth-bg min-h-[calc(100vh-160px)] flex items-center justify-center p-6 bg-slate-100 dark:bg-slate-950">
    <div class="glass w-full max-w-md p-10 rounded-[2.5rem] shadow-2xl border border-white/20" data-aos="zoom-in">
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-black text-slate-800 mb-2 tracking-tight">Set New Password</h1>
            <p class="text-slate-500 font-semibold text-sm">Update your institutional access credentials</p>
        </div>
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" value="{{ $email ?? old('email') }}" required placeholder="name@example.com" 
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    <span class="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg group-focus-within:text-orange-500 transition-colors">lock_reset</span>
            ...
            <button type="submit" class="w-full bg-slate-900 text-white font-black py-5 rounded-2xl shadow-xl hover:bg-slate-800 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 active:scale-95">
                Reset Password <span class="material-icons text-xl">update</span>
            </button>
        </form>
    </div>
</main>
